...
-- BORRADO DE ENTIDADES DE PRUEBA PARA EVITAR CONFLICTOS POR EJECUCION REITERADA DE TESTS
BEGIN
    T_CUENTA_SEGREGADA CUENTA.CUENTA_ID%TYPE;
    T_CUENTA_POOLED CUENTA.CUENTA_ID%TYPE;

    SELECT CUENTA_ID INTO T_CUENTA_SEGREGADA FROM CUENTA WHERE IBAN LIKE 'TEST_ABRIR_CUENTA_IDEAL_SEGREGADA';
    SELECT CUENTA_ID INTO T_CUENTA_POOLED FROM CUENTA WHERE IBAN LIKE 'TEST_ABRIR_CUENTA_IDEAL_POOLED';

    DELETE FROM SEGREGADA WHERE CUENTA_FINTECH_ID = T_CUENTA_SEGREGADA;
    DELETE FROM CUENTA_FINTECH WHERE CUENTA_CUENTA_ID = T_CUENTA_SEGREGADA;
    DELETE FROM CUENTA WHERE CUENTA_ID = T_CUENTA_SEGREGADA;

    DELETE FROM POOLED_ACCOUNT WHERE CUENTA_FINTECH_ID = T_CUENTA_POOLED;
    DELETE FROM CUENTA_FINTECH WHERE CUENTA_CUENTA_ID = T_CUENTA_POOLED;
    DELETE FROM CUENTA WHERE CUENTA_ID = T_CUENTA_POOLED;
