...
CONT                INTEGER;
BEGIN
    SELECT ESTADO INTO ESTADO_CLIENTE FROM CLIENTE WHERE IDENTIFICACION LIKE P_IDENTIFICACION;
    SELECT ID INTO CLIENTE_ID FROM CLIENTE WHERE IDENTIFICACION LIKE P_IDENTIFICACION;

    -- check de existencia del cliente
    ...
    IF ESTADO_CLIENTE LIKE 'INACTIV[OAE]' THEN
